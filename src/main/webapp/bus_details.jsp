                    ...
                    <div class="container" style="display:flex;flex-direction: column; width: 66%">
                        <nav class="navbar navbar-light bg-light">
                            ...
                            <form action="" method="post" style="display: flex">
                                ...
                                <button class="btn fa fa-magnifying-glass" type="submit" style=""></button>    
                                
                            </form>

                        </nav>
                        <table class="table col-md-4 m-3" action="update_entry.jsp" method="get" >
                            <thead> 
                                <%
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="edit_entry.jsp?e=<%= q %>"class="btn btn-link" >Edit</a> </td>
                                    <td> <a href="delete_entry.jsp?d=<%=rs.getString(2)%>"class="btn btn-link" >Delete</a> </td>
                                </tr>      
                                <%
                                            }
                                        }
